...
void greetings(){
    ...
    if (time-> tm_hour < 12){
        cout<< "Good Morning  Akhil"<<endl;
        string phrase = "Good Morning Master Akhil";
        ...
        cout<< "Good Afternoon Master Akhil"<<endl;
        string phrase = "Good Afternoon Master Akhil";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
    }
        ...
        cout<< "Good Evening Master Akhil"<<endl;
        string phrase = "Good Evening Master Akhil";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
    }
...
int main()
{
    ...
    {
        cout<<"******************************************************"<<endl;
        cout<<"| ENTER THE PASSWORD TO CONFIRM YOU ARE AKHIL|"<<endl;
        cout<<"******************************************************"<<endl<<endl;
        string phrase = "ENTER THE PASSWORD TO CONFIRM YOU ARE AKHIL";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
        ...
        if(password=="akhil")
        {
            ...
            do{
                cout<<"\n<**********************************************************************************************>\n\n";
                cout<<endl<<"How can i help you Master Akhil...."<<endl<<endl;

                string phrase = "How can i help you Master Akhil";
                string command = "espeak \"" + phrase + "\"";
                const char *charCommand = command.c_str();
                system(charCommand);
                ...
                {
                    cout<<"Hello Master Akhil....."<<endl;
                    string phrase = "Hello Master Akhil";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
                ...
                {
                    cout<<"I'm a personal assistant created by Master Akhil !!!"<<endl;
                    string phrase = "I'm a personal assistant created by Master Akhil !!!";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
                ...
                {
                    cout<<"Good Bye Master Akhil, see you soon!"<<endl;
                    string phrase = "Good Bye Master Akhil, see you soon!";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    exit(0);
